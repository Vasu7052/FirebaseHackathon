 ...
 */
public class CustomAdapterForChat extends ArrayAdapter<ChatMessage> implements View.OnClickListener,Filterable {

    private ArrayList<ChatMessage> originalList;
    private ArrayList<ChatMessage> usersList;

    public CustomAdapterForChat(Context context, int textViewResourceId, ArrayList<ChatMessage> usersList ) {
        super(context, textViewResourceId, usersList);
        this.usersList = new ArrayList<ChatMessage>();
        this.usersList.addAll(usersList);
        this.originalList = new ArrayList<ChatMessage>();
    ...
    public int getItemViewType(int position) {
        ChatMessage message = usersList.get(position) ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      //  position = usersList.size() - position - 1;
        ...
        final ChatMessage users = usersList.get(position);
